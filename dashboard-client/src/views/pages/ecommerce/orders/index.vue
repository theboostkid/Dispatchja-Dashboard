              ...
              >
                ...
                <template v-slot:cell(orderstatus)="data">
                  <span
                    class="badge"
                    :class="{
                      'badge-warning': data.item.orderstatus === 'Processing',
                      'badge-success': data.item.orderstatus === 'Delivered',
                      'badge-info': data.item.orderstatus === 'Shipped',
                      'badge-danger': data.item.orderstatus === 'Cancelled',
                    }"
                  >
