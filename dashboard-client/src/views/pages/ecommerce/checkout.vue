                  ...
                  <tab-content title="Payment Info">
                    <div>
                      ...
                      <div class="border p-3 mb-3 rounded">
                        <div class="float-right">
                          <i
                            class="far fa-credit-card font-24 text-primary"
                          ></i>
                        </div>
                        <div
                          class="custom-control custom-radio custom-control-inline"
                      ...
                      <div class="border p-3 mb-3 rounded">
                        <div class="float-right">
                          <i
                            class="fas fa-money-bill-alt font-24 text-primary"
                          ></i>
                        </div>
                        <div
                          class="custom-control custom-radio custom-control-inline"
                          ...
                          <tr>
                            ...
                            <td>
                              <router-link
                                ...
                                >Blue color T-shirt</router-link
                              >
                          ...
                          <tr>
                            ...
                            <td>
                              <router-link
                                to="/ecommerce/product-detail/1"
                                class="text-body font-weight-semibold"
                                >Blue Hoodie for men</router-link
                              >
                          ...
                          <tr>
                            ...
                            <td>
                              <router-link
                                to="/ecommerce/product-detail/1"
                                class="text-body font-weight-semibold"
                                >Full sleeve Pink T-shirt</router-link
                              >
