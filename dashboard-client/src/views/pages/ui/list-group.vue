          ...
          <div class="card-body">
            ...
            <ul class="list-group">
              <li class="list-group-item">
                <i class="mdi mdi-google-drive mr-1"></i> Google Drive
              </li>
              <li class="list-group-item">
                <i class="mdi mdi-message-outline mr-1"></i> Facebook Messenger
              </li>
              <li class="list-group-item">
                <i class="mdi mdi-apple mr-1"></i> Apple Technology Company
              </li>
              <li class="list-group-item">
                <i class="mdi mdi-lifebuoy mr-1"></i> Intercom Support System
              </li>
              <li class="list-group-item">
                <i class="mdi mdi-credit-card-outline mr-1"></i> Paypal Payment
                Gateway
              </li>
            </ul>
          </div>
