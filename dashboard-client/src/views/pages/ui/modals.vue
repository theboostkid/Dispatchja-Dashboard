          ...
          <div class="card-body">
            ...
            <div class="button-list">
              ...
              <b-modal
                ...
                >...</b-modal
              >
              <b-button v-b-modal.modal-sm variant="success"
              ...
              <b-button v-b-modal.modal-fullWidth variant="primary"
                >Full width Modal</b-button
              >
              <b-modal
                id="modal-fullWidth"
                title="Modal Heading"
              ...
              <b-button v-b-modal.modal-center variant="purple"
              ...
              <b-modal
                ...
                >...</b-modal
              >
              <b-button v-b-modal.modal-scrollable variant="pink"
                >Scrollable</b-button
              >
              <b-modal
                id="modal-scrollable"
      ...
      <div class="col-xl-6">
        <div class="card">
          <div class="card-body">
            ...
            <p class="sub-header">Examples of custom modals.</p>
            <div class="button-list">
              <b-button v-b-modal.modal-responsive variant="success"
                >Responsive Modal</b-button
              >
              <b-modal
                id="modal-responsive"
              ...
              <!-- Accordion modal -->
              <b-button v-b-modal.modal-accordion variant="secondary"
                >Accordion in Modal</b-button
              >
              <b-modal
                id="modal-accordion"
                hide-header
